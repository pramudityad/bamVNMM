          ...
          <Col xs="12" lg="12">
            {this.state.data_assignment !== null && (
              <Card>
                ...
                <CardFooter>
                  {(this.state.data_assignment.Current_Status === "REQUEST PM APPROVAL" || this.state.data_assignment.Current_Status === "ASP ASSIGNMENT NEED REVISION" || this.state.data_assignment.Current_Status === "ASP ASSIGNMENT RE-SCHEDULE") && (
