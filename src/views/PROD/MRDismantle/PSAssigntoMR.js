...
class PSAssigntoMR extends Component {
  ...
  getListTssrAll() {
    this.getDataFromAPINODE(
      '/plantspec-srn?q={"mra_id" : null, "submission_status" : "SUBMITTED", "site_info.site_id" : "' +
        this.state.data_mr.site_info[0].site_id +
        '", "plantspec_srn_category_code" : "' +
  ...
  prepareSelectionTSSR(list_tssr) {
    ...
    list_tssr_filter.map((tssr) =>
      list_tssr_selection.push({
        label: tssr.no_plantspec_srn,
        value: tssr._id,
      })
    );
            ...
            <Card>
              <CardHeader>
                ...
                <Button
                  color="success"
                  style={{ float: "right" }}
                  disabled={this.state.ps_dis_data.srn_packages === undefined}
                  onClick={this.connectMRtoPSDismantle}
                >
                  Assign
                </Button>
              </CardHeader>
                    ...
                    {this.state.data_mr !== null && (
                      <Fragment>
                        ...
                        <tr>
                          ...
                          >
                            Category : {this.state.data_mr.mrd_category}
                          </td>
                        </tr>
                        <tr>
                          <td
                          ...
                          >
                            MR Site : {this.state.data_mr.site_info[0].site_id}
                          </td>
                        </tr>
                      </Fragment>
                    )}
