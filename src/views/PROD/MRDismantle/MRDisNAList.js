...
class MRDisNAList extends Component {
  ...
  async getAllMRAList() {
    ...
    const res = await this.getDataFromAPINODE(
      "/matreq-srn?srt=_id:-1&q=" + whereAnd
    );
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownItem onClick={this.downloadMRNAList}>
                            {" "}
                            <i
                              className="fa fa-file-text-o"
                              aria-hidden="true"
                            ></i>
                            Download MRA Need Assign List
                          </DropdownItem>
                        </DropdownMenu>
                      </Dropdown>
                    </React.Fragment>
                ...
                <Table responsive striped bordered size="sm">
                  ...
                  <tbody>
                    ...
                    {this.state.mr_dis_list.map((list, i) => (
                      <tr key={list._id}>
                        <td>
                          <Link to={"/srn/mr-srn-na-list/" + list._id}>
