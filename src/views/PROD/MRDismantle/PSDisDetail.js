...
class PSDisDetail extends Component {
  ...
  async loadOptionsTowerID(inputValue) {
    if (!inputValue || inputValue.length < 3) {
      ...
      const getTowerID = await getDatafromAPIEXEL(
        '/tower_site_op?where={"tower_id":{"$regex":"' +
          inputValue +
          '", "$options":"i"}}'
      );
  ...
  async submitPSDis() {
    const res = await patchDatatoAPINODE(
      "/plantspec-srn/submitPlantspecSRN/" + this.props.match.params.id,
      {},
                        ...
                        <tbody>
                          ...
                          <Fragment>
                            <tr>
                              ...
                              >
                                Plant Spec Dismantle ID :{" "}
                                {this.state.ps_dis_data.no_plantspec_srn}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Project Name :{" "}
                                {this.state.ps_dis_data.project_name}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Tower ID :{" "}
                                {this.state.ps_dis_data.site_info !== undefined
                                  ? this.state.ps_dis_data.site_info.map(
                                      (psd) =>
                                        psd.site_id + " (" + psd.site_name + ")"
                                    )
                                  : null}
                              </td>
                            </tr>
                            <tr>
                              ...
                              >
                                MRA Related : {this.state.ps_dis_data.mra_id}
                              </td>
                            </tr>
                            <tr>
                              <td
                            ...
                            <tr>
                              ...
                              >
                                Category Dis :{" "}
                                {this.state.ps_dis_data.plantspec_srn_category}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Current Status :{" "}
                                {this.state.ps_dis_data.current_status}
                              </td>
                            </tr>
                          </Fragment>
                        </tbody>
                  ...
                  <Row>
                    <Col md="12">
                      <Table hover bordered striped responsive size="sm">
                        ...
                        <tbody>
                          {this.state.ps_dis_data.srn_packages !== undefined &&
                            this.state.ps_dis_data.srn_packages
                              .filter(
