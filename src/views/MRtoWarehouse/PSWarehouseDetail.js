...
class PSDisDetail extends Component {
  ...
  async getDataPSDis(_id) {
    const res = await getDatafromAPINODE(
      "/plantspec/" + _id,
  ...
  async updateMaterialQty() {
    ...
    const resPatch = await patchDatatoAPINODE(
      "/matreq-srn/updateMaterialPlantSpec/" + dataPS._id,
      dataUpload,
      this.state.tokenUser
    );
                        ...
                        <tbody>
                          ...
                          <Fragment>
                            <tr>
                              ...
                              >
                                Plant Spec WH ID :{" "}
                                {this.state.ps_wh_data.no_plantspec}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Project Name :{" "}
                                {this.state.ps_wh_data.project_name}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Origin Warehouse :{" "}
                                {this.state.ps_wh_data.origin_wh !== undefined
                                  ? this.state.ps_wh_data.origin_wh.value
                                  : null}
                              </td>
                            </tr>
                            <tr>
                              ...
                              >
                                ...
                                {this.state.ps_wh_data.destination_wh !==
                                undefined
                                  ? this.state.ps_wh_data.destination_wh.value
                                  : null}
                              </td>
                            </tr>
                            <tr>
                              ...
                              >
                                MR Warehouse Related :{" "}
                                {this.state.ps_wh_data.mra_id}
                              </td>
                            </tr>
                            <tr></tr>
                            <tr>
                              ...
                              >
                                Type PS : {this.state.ps_wh_data.plantspec_type}
                              </td>
                            </tr>
                            <tr>
                              <td
                              ...
                              >
                                Current Status :{" "}
                                {this.state.ps_wh_data.current_status}
                              </td>
                            </tr>
                          </Fragment>
                        </tbody>
                  ...
                  <Row>
                    <Col md="12">
                      <Table hover bordered striped responsive size="sm">
                        ...
                        <tbody>
                          {this.state.ps_wh_data.packages !== undefined &&
                            this.state.ps_wh_data.packages
                              .filter(
