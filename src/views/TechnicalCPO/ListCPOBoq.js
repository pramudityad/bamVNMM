...
class ListCPOBoq extends Component {
  ...
  getCpoBoqList() {
    ...
    this.getDataFromAPINODE(
      "/cpoBoqList?srt=cpo_boq_id:-1&lmt=" +
        this.state.perPage +
        "&pg=" +
      ...
      if (res.data !== undefined) {
        this.setState({
          list_cpo_boq: res.data.data,
          list_cpo_boq_filter: res.data.data,
  ...
  changeFilterName(value) {
    ...
    if (value !== null) {
      ...
      const dataFilter = dataCPOBOQ.filter((cpo) =>
        globalRegex.test(cpo.cpo_number)
      );
                ...
                <Table hover bordered striped responsive size="sm">
                  <thead>
                    <tr>
                      ...
                      <th>CPO BOQ</th>
                      <th>Creator</th>
                      <th style={{ width: "225px", textAlign: "center" }}>
                        Action
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {this.state.list_cpo_boq_filter
