...
class ListTSSRBoq extends Component {
  ...
  getTechBoqList(){
    ...
    let where = 'q={'+filter_no_tech+', '+filter_project+', '+filter_ver+', '+filter_status+', "current_status" : "TSSR BOQ CREATED"}';
    this.getDataFromAPINODE('/tssr/getTssr?srt=_id:-1&'+where+ "&lmt=" +
    this.state.perPage +
    "&pg=" +
