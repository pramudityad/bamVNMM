...
class MRNAList extends Component {
  ...
  getMRList() {
    ...
    let whereAnd = '{"current_mr_status" : "NOT ASSIGNED", "mr_id": '+filter_mr_id+', "implementation_id": '+filter_implementation_id+', "cd_id": '+filter_cd_id+', "current_milestones": '+filter_current_milestones+', "dsp_company": '+filter_dsp+', "eta": '+filter_eta+', "updated_on": '+filter_updated_on+', "created_on": '+filter_created_on+'}';
