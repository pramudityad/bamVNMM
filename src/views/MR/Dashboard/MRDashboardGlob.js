    ...
    return (
      <div className="animated fadeIn">
        ...
        <Row>
          ...
          <Col xs="12" sm="6" lg="4">
            <a href="#" onMouseEnter={() => this.updateHover8("")} onMouseLeave={() => this.updateHover8("inverse")}>
              <Widget color="success" variant={this.state.variant8} header="999" mainText="GR" smallText="" imageSource={this.state.img_10}/>
            </a>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <a href="#" onMouseEnter={() => this.updateHover9("")} onMouseLeave={() => this.updateHover9("inverse")}>
              <Widget color="warning" variant={this.state.variant9} header="999" mainText="GI" smallText="" imageSource={this.state.img_11}/>
            </a>
          </Col>
        </Row>
      </div>
