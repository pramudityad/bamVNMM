...
class MRDashboardGlob extends Component {
  ...
  getMaterialDispatch() {
    this.getDataFromAPINODE('/matreq?q={"$or" : [{"current_milestones": "MS_DISPATCH"}, {"current_milestones": "MS_LOADING_PROCESS", "current_mr_status": "LOADING PROCESS FINISH"}]}&lmt=1&v={"_id" : 1}').then(res => {
