    ...
    return (
      <div>
        ...
        <Card>
          <CardHeader>
            <React.Fragment>
              <span style={{marginTop:'8px'}}>Commercial BOQ List</span>
            </React.Fragment>
          </CardHeader>
          <CardBody className='card-UploadBoq'>
            <Table hover bordered striped responsive size="sm">
              <thead>
                  <tr>
                    <th>Technical BOQ No.</th>
                    <th>Commercial BOQ No.</th>
                    <th>Project</th>
                    <th>Ver.</th>
              ...
              <tbody>
                ...
                <tr>
                    <td style={{verticalAlign : 'middle'}}>TECBOQ-200120-0001</td>
                    <td style={{verticalAlign : 'middle'}}>COMBOQ-200121-0002</td>
                    <td style={{verticalAlign : 'middle'}}>LTE 2020</td>
                    <td style={{verticalAlign : 'middle'}}>0</td>
                    <td style={{verticalAlign : 'middle', textAlign : "center"}}>
                ...
                <tr>
                    ...
                    <td style={{verticalAlign : 'middle'}}>COMBOQ-200121-0004</td>
                    <td style={{verticalAlign : 'middle'}}>LTE 2020</td>
                    <td style={{verticalAlign : 'middle'}}>0</td>
                    <td style={{verticalAlign : 'middle', textAlign : "center"}}>
