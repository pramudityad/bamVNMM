...
class CommercialBoqProject extends Component {
  constructor(props) {
    super(props);
      ...
      this.setState(
        {
          ...
          list_version: new Array(parseInt(dataComm.data.version) + 1).fill(
            "0"
          ),
        },
        () => {
  ...
  dataViewPagination(dataCommView) {
    ...
    if (perPage !== dataCommView.length) {
      ...
      dataTechPage = dataCommView.slice(
        pageNow * perPage,
        (pageNow + 1) * perPage
      );
    } else {
  ...
  exportCommercialTemplate = async () => {
    ...
    saveAs(
      new Blob([comFormat]),
      "Commercial BOQ " + dataComm.no_comm_boq + " Format.xlsx"
    );
  };
  ...
  render() {
    if (this.state.redirectSign !== false) {
      return (
        <Redirect to={"/list-commercial/detail/" + this.state.redirectSign} />
      );
    }
                      ...
                      <DropdownMenu>
                        ...
                        {this.state.userRole.length !== 0 &&
                          this.state.userRole.includes(
                            "BAM-CommBoq-ViewWithoutPrice"
                          ) === false && (
                            <DropdownItem
                              onClick={this.exportCommercialTemplate}
                            >
                              {" "}
                              <i
                                className="fa fa-file-text-o"
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              >
                                ...
                                {this.state.data_tech_boq_selected === null
                                  ? "Save"
                                  : this.state.data_tech_boq_sites_selected
                                      .length !== 0
                                  ? "Save"
                                  : "Loading.."}
                              </Button>
                    ...
                    <Table hover bordered responsive size="sm" width="100%">
                      ...
                      <tbody>
                        ...
                        this.state.data_comm_boq.version !==
                                      ...
                                      <React.Fragment>
                                        <td style={{ width: "75px" }}>
                                          <Input
                                            ...
                                            placeholder=""
                                            onChange={
                                              this.handleChangeUnitPriceUSD
                                            }
                                            value={
                                              !this.state.UnitPriceUSDChange.has(
                                                item.site_id +
                                                  " /// " +
                                                  item.config_id
                                              )
                                                ? item.net_price_incentive_usd
                                                : this.state.UnitPriceUSDChange.get(
                                                    item.site_id +
                                                      " /// " +
                                                      item.config_id
                                                  )
                                        ...
                                        <td style={{ width: "200px" }}>
                                          <Input
                                            ...
                                            placeholder=""
                                            onChange={
                                              this.handleChangeUnitPriceIDR
                                            }
                                            value={
                                              !this.state.UnitPriceIDRChange.has(
                                                item.site_id +
                                                  " /// " +
                                                  item.config_id
                                              )
                                                ? item.net_price_incentive
                                                : this.state.UnitPriceIDRChange.get(
                                                    item.site_id +
                                                      " /// " +
                                                      item.config_id
                                                  )
                                        ...
                                        <td style={{ width: "100px" }}>
                                          {!this.state.TotalPriceUSDChange.has(
                                            item.site_id +
                                              " /// " +
                                              item.config_id
                                          )
                                            ? item.total_price_incentive_usd
                                            : this.state.TotalPriceUSDChange.get(
                                                item.site_id +
                                                  " /// " +
                                                  item.config_id
                                              )}
                                        ...
                                        <td style={{ width: "200px" }}>
                                          {!this.state.TotalPriceIDRChange.has(
                                            item.site_id +
                                              " /// " +
                                              item.config_id
                                          )
                                            ? item.total_price_incentive
                                            : this.state.TotalPriceIDRChange.get(
                                                item.site_id +
                                                  " /// " +
                                                  item.config_id
                                              )}
                          ...
                          : this.state.data_comm_boq_items_pagination.map(
                              (site) =>
                                site.items.map((item) => (
                                  <tr>
                                    <td>{item.site_id}</td>
                                        ...
                                        <React.Fragment>
                                          ...
                                          <td style={{ width: "120px" }}>
                                            {!this.state.TotalPriceUSDChange.has(
                                              ...
                                              ? item.total_price_incentive_usd.toFixed(
                                                  2
                                                )
                                              : this.state.TotalPriceUSDChange.get(
                                                  item.site_id +
                                          ...
                                          <td style={{ width: "120px" }}>
                                            {!this.state.TotalPriceIDRChange.has(
                                              ...
                                              ? item.total_price_incentive.toFixed(
                                                  2
                                                )
                                              : this.state.TotalPriceIDRChange.get(
                                                  item.site_id +
...
export default connect(mapStateToProps)(CommercialBoqProject);
