...
class JointCheck extends Component {
  ...
  getMRList() {
    ...
    let whereAnd = '{"mr_id": '+filter_mr_id+', "implementation_id": '+filter_implementation_id+', "cd_id": '+filter_cd_id+', "current_mr_status": '+filter_current_status+', "current_milestones": "MS_JOINT_CHECK", "dsp_company": '+filter_dsp+', "eta": '+filter_eta+', "updated_on": '+filter_updated_on+', "created_on": '+filter_created_on+'}';
  ...
  async proceedMilestone(e) {
    ...
    let successUpdate = [];
    let updateMilestone = {};
    updateMilestone['current_milestones'] = "MS_LOADING_PROCESS";
      ...
      <div className="animated fadeIn">
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> Joint Check
              </CardHeader>
              <CardBody>
