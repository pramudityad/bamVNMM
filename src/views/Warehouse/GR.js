...
class GR extends Component {
  ...
  getMRList() {
    ...
    // console.log('GR filter ', filter_mr_id);
    ...
    let whereAnd = '{"mr_id": '+filter_mr_id+',"dsp_handover.location":"warehouse", "asp_material_gi" : null}';
    console.log('GR filter ', whereAnd);
  ...
  async downloadMRlist() {
    ...
    saveAs(new Blob([allocexport]), 'GR.xlsx');
  }
            ...
            <Card>
              <CardHeader>
                <span style={{lineHeight :'2'}}>
                  <i className="fa fa-align-justify" style={{marginRight: "8px"}}></i> GR
                </span>
...
export default connect(mapStateToProps)(GR);
