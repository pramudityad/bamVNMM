    ...
    for (let i = 0; i < allAssignmentList.length; i++) {
      ...
      let rowAdded = [
        ...
        dataAccepted.status_date !== undefined
          ? dataAccepted.status_date.slice(0, 10)
          : null,
      ...
      if (dataGR[0] !== undefined) {
        rowAdded.push(
          dataGR[0].Requestor,
          new Date(dataGR[0].created_on),
          dataGR[0].GR_Document_No,
          dataGR[0].GR_Document_Date
        );
      } else {
      ...
      if (dataGR[1] !== undefined) {
        rowAdded.push(
          dataGR[1].Requestor,
          new Date(dataGR[1].created_on),
          dataGR[1].GR_Document_No,
          dataGR[1].GR_Document_Date
        );
      } else {
        rowAdded.push(null, null, null, null);
      }
      ...
      if (
        ...
        ws.getCell("L" + getRowLast).value = new Date(
      ...
      if (
        ...
        ws.getCell("U" + getRowLast).value = new Date(
          allAssignmentList[i].PO_Date
        );
      ...
      if (
        dataGR[0] !== undefined &&
        dataGR[0].created_on !== null &&
        dataGR[1].created_on !== undefined
      ) {
      ...
      if (
        dataGR[0] !== undefined &&
        dataGR[0].GR_Document_Date !== null &&
        dataGR[1].GR_Document_Date !== undefined
      ) {
        ws.getCell("AA" + getRowLast).numFmt = new Date(
          dataGR[0].GR_Document_Date
        );
      ...
      if (
        dataGR[1] !== undefined &&
        dataGR[1].GR_Document_Date !== null &&
        dataGR[1].GR_Document_Date !== undefined
      ) {
        ws.getCell("AE" + getRowLast).numFmt = new Date(
          dataGR[1].GR_Document_Date
        );
