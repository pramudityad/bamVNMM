      ...
      <div className="animated fadeIn">
        ...
        <Row>
          <Col xs="12" lg="12">
            <Card>
              <CardHeader>
                <span style={{lineHeight :'2', fontSize : '17px'}}><i className="fa fa-edit" style={{marginRight: "8px"}}></i>FMS Upload</span>
              </CardHeader>
              <CardBody>
                <Form>
                  <Row>
              ...
              <CardFooter>
                <Button type="submit" color="success" style={{float: "right"}} onClick={this.togglecreateModal}> Upload File</Button>
              </CardFooter>
            </Card>
          </Col>
        </Row>
