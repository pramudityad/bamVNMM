        ...
        for (let i = 0; i < this.state.project_in_bulk.length; i++) {
          ...
          dataAssignmentforProject.map(
            (asg) =>
              (dataTableASGEmail =
                dataTableASGEmail +
                "<tr><td><a href='https://bam-id.e-dpm.com/assignment-detail/" +
                asg._id +
                "' style='padding:5px'>" +
                asg.Assignment_No +
          ...
          const bodyEmail =
            "<span style='font-size:30px;font-weight:800;'>Approval Request</span><br/><br/><span>You have a request for Assignment Approval because the assignment not using list SSOW from the mapping</span><br/><br/><span style='font-size:20px;font-weight:600;'>Approval Request</span><br/><br/><span>This is automate generate email from DPM - BAM. Follow this link below to open detail request : </span><br/><body><table cellspacing='0' cellpadding='0' align='center' border='1'><tr><td>Assignment</td><td>Project</td><td>Site</td></tr>" +
            dataTableASGEmail +
            "</table></body><br/><br/><span style='font-size:20px;font-weight:600;'>Don't know what this is?</span><br/><br/><span>This message is sent from DPM - BAM, since you are registered as one of the approval role. Questions are welcome to dpm.notification@ericsson.com</span>";
          let dataEmail = {
            ...
            <Card>
              <CardHeader>
                ...
                <select
                  ...
                  value={this.state.uploadan_type}
                  disabled={this.state.rowsXLS.length !== 0}
                >
                  <option value="without Predefined SSOW">
                    without Predefined SSOW
                  </option>
                ...
                <Button
                  ...
                  outline
                  color="info"
                  onClick={this.exportFormatBulkAssignmentMigration}
                  size="sm"
                >
                  <i
                    className="fa fa-download"
                    style={{ marginRight: "8px" }}
                  ></i>
                  Download Assignment Format For Migration
                </Button>
                <select
                  type="select"
                    ...
                    <Row>
                      <Col>
                        ...
                        <span style={{ color: "red" }}>
                          *NOTIFIED TO ASP MUST BE FILLED IN
                        </span>
                        <Button
                          color="success"
                          onClick={this.saveDataAssignmentBulkMigration}
                          style={{ float: "right" }}
                        >
                  ...
                  <tbody>
                    <tr>
                      <td colSpan="4" style={{ textAlign: "center" }}>
                        BULK ASP ASSIGNMENT PREVIEW {this.state.uploadan_type}
                      </td>
                    </tr>
                    <tr>
                      <td
