...
class AssignmentDetailASP extends Component {
      ...
      if (this.state.data_assignment.SSOW_List[i] !== undefined) {
        ssow_content.push(
          <Row
            ...
            key={this.state.data_assignment.SSOW_List[i].ssow_id}
          >
            <Col md="2" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  type="text"
                  name="17"
                  value={this.state.data_assignment.SSOW_List[i].ssow_id}
                  readOnly
                />
              </FormGroup>
            </Col>
            <Col md="2" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  ...
                  name="18"
                  value={
                    this.state.data_assignment.SSOW_List[i].ssow_activity_number
                  }
                  readOnly
                />
              </FormGroup>
            ...
            <Col md="4" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  ...
                  readOnly
                  value={
                    this.state.data_assignment.SSOW_List[i].ssow_description
                  }
                />
              </FormGroup>
            </Col>
            <Col md="1" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  type="text"
                  name="20"
                  value={this.state.data_assignment.SSOW_List[i].ssow_unit}
                  readOnly
                />
              </FormGroup>
            </Col>
            <Col md="1" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  type="number"
                  name="21"
                  value={this.state.data_assignment.SSOW_List[i].ssow_qty}
                  readOnly
                />
              </FormGroup>
            </Col>
            <Col md="2" style={{ margin: "0", padding: "4px" }}>
              <FormGroup>
                ...
                <Input
                  ...
                  name="22"
                  value={
                    this.state.data_assignment.SSOW_List[i].ssow_status[
                      this.state.data_assignment.SSOW_List[i].ssow_status
                        .length - 1
                    ].status
                  }
  ...
  async acceptASG(e) {
    ...
    if (res !== undefined) {
      if (res.data !== undefined) {
        ...
        const bodyEmail =
          "<h2>DPM - BAM Notification</h2><br/><span>Please be notified that the following Assignment has been approved by ASP, <br/><br/><i>Site</i>: <b>" +
          dataAssignment.Site_ID +
          "</b> <br/><i>Project</i>: <b>" +
          dataAssignment.Project +
          "</b><br/><i>Assignment</i>: <b>" +
          dataAssignment.Assignment_No +
          "</b><br/><br/>is approved by " +
        ...
        let dataEmail = {
          ...
          subject:
            "[APPROVED by ASP] Assignment " + dataAssignment.Assignment_No,
          body: bodyEmail,
        };
  ...
  async revisionASG(e) {
    if (this.state.revision_note === "") {
      ...
      let creator = dataAssignment.ASP_Assignment_Status.find(
        (e) =>
          e.status_value === "CREATED" && e.status_name === "ASP_ASSIGNMENT"
      );
      if (creator !== undefined) {
        creatorEmail = creator.status_updater;
      }
      ...
      if (res !== undefined) {
        if (res.data !== undefined) {
          let linkImp = "https://bam-id.e-dpm.com/assignment-detail/" + _id;
          const bodyEmail =
            "<h2>DPM - BAM Notification</h2><br/><span>Please be notified that the following Assignment has been requested for Revision by ASP, <br/><br/><i>Site</i>: <b>" +
            dataAssignment.Site_ID +
            "</b> <br/><i>Project</i>: <b>" +
            dataAssignment.Project +
            "</b><br/><i>Assignment</i>: <b>" +
            dataAssignment.Assignment_No +
            "</b><br/><br/>is requested for revision by " +
            this.state.userEmail +
            ".</span><br/><i>Note from ASP</i>: <b>" +
            this.state.revision_note +
          ...
          let dataEmail = {
            ...
            // "to" : "a.rakha.ahmad.taufiq@ericsson.com",
            subject:
              "[Request Revision by ASP] Assignment " +
              dataAssignment.Assignment_No,
            body: bodyEmail,
          };
          // let sendEmail = await this.apiSendEmail(dataEmail);
    ...
    if (this.state.reschedule_note === "") {
      ...
      if (res !== undefined) {
        if (res.data !== undefined) {
          let linkImp = "https://bam-id.e-dpm.com/assignment-detail/" + _id;
          const bodyEmail =
            "<h2>DPM - BAM Notification</h2><br/><span>Please be notified that the following Assignment has been requested for Reschedule by ASP, <br/><br/><i>Site</i>: <b>" +
            dataAssignment.Site_ID +
            "</b> <br/><i>Project</i>: <b>" +
            dataAssignment.Project +
            "</b><br/><i>Assignment</i>: <b>" +
          ...
          let dataEmail = {
            ...
            // "to" : "a.rakha.ahmad.taufiq@ericsson.com",
            subject:
              "[Request Reschedule by ASP] Assignment " +
              dataAssignment.Assignment_No,
            body: bodyEmail,
          };
          // let sendEmail = await this.apiSendEmail(dataEmail);
  ...
  exportFormatBulkAssignment = async () => {
    ...
    let headerRow = [
      ...
      "ssow_rbs_quantity_5",
      "ssow_rbs_id_6",
      "ssow_rbs_activity_number_6",
      "ssow_rbs_unit_6",
      "ssow_rbs_quantity_6",
      "ssow_rbs_id_7",
      "ssow_rbs_activity_number_7",
      "ssow_rbs_unit_7",
      "ssow_rbs_quantity_7",
    ];
                  ...
                  <Form>
                    ...
                    <Row>
                      <Col md="6">
                        ...
                        <FormGroup
                          style={{ paddingLeft: "16px", display: "none" }}
                        >
                          <Label>MR ID</Label>
                    ...
                    <h5 style={{ marginTop: "16px" }}>
                      SSOW {this.state.data_assignment.SOW_Type}
                    </h5>
                    <Row>
                      <Col md="12">
                        <Table
                            ...
                            {this.state.data_assignment.SSOW_List !==
                              ...
                              this.state.data_assignment.SSOW_List.map(
                                (ssow) => (
                                  <tr
                                    key={
                                      ssow.ssow_id + ssow.ssow_activity_number
                                    }
                                  >
                                    <td>{ssow.ssow_id}</td>
