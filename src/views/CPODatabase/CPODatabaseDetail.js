...
class CPODatabaseDetail extends Component {
  ...
  exportFormatCPOParentWithDetail = async () => {
    ...
    for (let i = 0; i < dataPO.cpoDetail.length; i++) {
      ...
      ws.addRow([
        dataPO.po_number.toString(),
        dataPO.date.substring(0, 10),
        dataPO.currency,
        dataPO.payment_terms,
        dataPO.shipping_terms,
        dataPO.contract,
        dataPO.contact,
        e.config_id,
        e.description,
            ...
            <Card>
              <CardHeader>
                ...
                {this.state.userRole.findIndex(
                  (e) => e === "BAM-CpoDB-ViewWithoutPrice"
                ) === -1 && (
                  <div
                      ...
                      >
                        ...
                        <DropdownMenu>
                          ...
                          this.state.data_cpo_db.length === 0 ? (
                            ...
                            <DropdownItem
                              onClick={this.exportFormatCPOParentWithDetail}
                            >
                              {" "}
                              CPO Data With Detail
                            </DropdownItem>
                          )}
                        ...
                        <table className="table-header">
                          <tbody>
                            ...
                            <tr style={{ fontWeight: "425", fontSize: "15px" }}>
                              ...
                              <td>:</td>
                              <td>
                                {convertDateFormat(this.state.data_cpo.date)}
                              </td>
                            </tr>
                            <tr style={{ fontWeight: "425", fontSize: "15px" }}>
                              <td>Aging</td>
