...
const ProductPackage = React.lazy(() =>
  import("./viewsTelkomsel/ProductPackage/PackageUpload")
);
const ServiceLibrary = React.lazy(() =>
  import("./viewsTelkomsel/SVC/ServiceLibrary")
);
const ConfigManager = React.lazy(() =>
  import("./viewsTelkomsel/Configlib/Configlibrary")
);

const ListTechnical = React.lazy(() =>
  import("./viewsTelkomsel/Technical/ListTechnical")
);
const DetailTechnical = React.lazy(() =>
  import("./viewsTelkomsel/Technical/TechnicalBoq")
);
const SummaryBoq = React.lazy(() =>
  import("./viewsTelkomsel/Technical/SummaryBoq")
);

// const DetailCommercialPO = React.lazy(() => import('./viewsTelkomsel/Commercial/CommercialBoqPO'));
const ApprovalCommercial = React.lazy(() =>
  import("./viewsTelkomsel/Commercial/CommercialBoqApproval")
);
const SubmissionCommBoq = React.lazy(() =>
  import("./viewsTelkomsel/Commercial/SubmissionCommBoq")
);

const ListTssrMatrix = React.lazy(() =>
  import("./viewsTelkomsel/TssrMatrix/ListTSSRBoq")
);
const DetailTssrMatrix = React.lazy(() =>
  import("./viewsTelkomsel/TssrMatrix/UploadTSSRMatrix")
);
const NewTssrMatrix = React.lazy(() =>
  import("./viewsTelkomsel/TssrMatrix/TSSRbyTech")
);

const ListTSSRBoq = React.lazy(() =>
  import("./viewsTelkomsel/Tssr/ListTSSRBoq")
);
...
const BulkChangeApproval = React.lazy(() =>
  import("./viewsTelkomsel/MR/ListChangeApproval")
);
const BulkApproval = React.lazy(() =>
  import("./viewsTelkomsel/MR/ListBulkApproval")
);
const BulkRequest = React.lazy(() => import("./viewsTelkomsel/MR/BulkRequest"));
const MRDashboardGlob = React.lazy(() =>
  import("./viewsTelkomsel/MR/DashMR/MRDashboardGlob")
);

const OrderReceived = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/OrderReceived")
);
const OrderProcessing = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/OrderProcessing")
);
const ReadyToDeliver = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/ReadyToDeliver")
);
...
const MaterialDispatch = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/MaterialDispatch")
);
...
const AssignmentCreation = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentCreation")
);
const AssignmentList = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentList")
);
const AssignmentReport = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentReport")
);
const BulkAssignment = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/BulkAssignment")
);
const AssignmentDetail = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentDetail")
);
const AssignmentEdit = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentEdit")
);
const AssignBast = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignBast")
);
const BulkNotifytoASP = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/BulkNotifytoASP")
);
const AssignmentListASP = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentListASP")
);
const AssignmentDetailASP = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentDetailASP")
);
const AssignmentListApproval = React.lazy(() =>
  import("./viewsTelkomsel/Assignment/AssignmentListApproval")
);

const WHManagement = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/WHManagement")
);

const ShipmentList = React.lazy(() =>
  import("./viewsTelkomsel/ShipmentList/ShipmentList")
);

const ASPManagement = React.lazy(() => import("./viewsTelkomsel/ASP/ASPUser"));
const ASPManagementDet = React.lazy(() =>
  import("./viewsTelkomsel/ASP/ASPUserDet")
);

const WHDashboard = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/Dashboard/WHDashboard")
);
const WHDashboardDet = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/Dashboard/WHDashboardDet")
);

const GRExternal = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/External/GR")
);
const GIExternal = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/External/GI")
);
const GRInternalDet = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/Internal/GRInternal")
);
const GIInternalDet = React.lazy(() =>
  import("./viewsTelkomsel/Milestone/Internal/GIInternal")
);

const WHDashboardExt = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/Dashboard/WHDashboardext")
);
const WHDashboardExtDet = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/Dashboard/WHDashboardextDet")
);

const MaterialStock = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/MatStock")
);
const MaterialInboundPlan = React.lazy(() =>
  import("./viewsTelkomsel/Warehouse/MatInboundPlan")
);

const DSACreation = React.lazy(() =>
  import("./viewsTelkomsel/DSA/DSACreation")
);
...
const LCCCreation = React.lazy(() =>
  import("./viewsTelkomsel/LCC/LCCCreation")
);
...
const PRPOCreation = React.lazy(() =>
  import("./viewsTelkomsel/PRPO/CreatePRPO")
);
...
const MRANeedConfirm = React.lazy(() =>
  import("./viewsTelkomsel/MRA/MRANeedConfirm")
);
...
const MatLibrary = React.lazy(() =>
  import("./viewsTelkomsel/MatLibrary/MatLibrary")
);

const MRDisList = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/MRDisList")
);
const MRDisCreation = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/MRDisCreation2")
);
const MRDisDetail = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/MRDisDetail")
);

const MRDisNAList = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/MRDisNAList")
);
const PSAssigntoMR = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/PSAssigntoMR")
);

const LDMApprovalDismantle = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/LDMApprovalDismantle")
);
const MRDismantleConfirmWH = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/MRDismantleConfirmWH")
);

const PSDisList = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/PSDisList")
);
const PSDisCreation = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/PSDisCreation")
);
const PSDisDetail = React.lazy(() =>
  import("./viewsTelkomsel/MRDismantle/PSDisDetail")
);

const ListTechnicalMW = React.lazy(() =>
  import("./viewsTelkomsel/Microwave/Technical/ListTechnicalMW")
);
const DetailTechnicalMW = React.lazy(() =>
  import("./viewsTelkomsel/Microwave/Technical/TechnicalBoqMW")
);
const SummaryBoqMW = React.lazy(() =>
  import("./viewsTelkomsel/Microwave/Technical/SummaryBoqMW")
);

const PSCreationMW = React.lazy(() =>
  import("./viewsTelkomsel/PS/PSCreationMW")
);
const PSBOMDetailMW = React.lazy(() =>
  import("./viewsTelkomsel/PS/PSDetailMW")
);

const PSWHList = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/PSWarehouseList")
);
const PSWHCreation = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/PSWarehouseCreation")
);
const PSWHDetail = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/PSWarehouseDetail")
);

const MRWHList = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/ListMRWarehouse")
);
const MRWHNAList = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/MRWHNAList")
);
const AssingPStoMRWH = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/AssingPStoMRWH")
);
const MRWHDismantle = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/MRWHDismantle")
);
const MRWHConfirm = React.lazy(() =>
  import("./viewsTelkomsel/MRtoWarehouse/MRWHConfirm")
);

const DSAMigration = React.lazy(() =>
  import("./viewsTelkomsel/DSA/DSAMigration")
);
...
const AdditionalPackage = React.lazy(() =>
  import("./viewsTelkomsel/ProductPackage/AdditionalPackage")
);

const DSADCreation = React.lazy(() =>
  import("./viewsTelkomsel/DSADismantle/DSADCreation")
);
const DSADList = React.lazy(() =>
  import("./viewsTelkomsel/DSADismantle/DSADList")
);
const DSADDetail = React.lazy(() =>
  import("./viewsTelkomsel/DSADismantle/DSADDetail")
);
const DSADEdit = React.lazy(() =>
  import("./viewsTelkomsel/DSADismantle/DSADEdit2")
);

const DSADMigration = React.lazy(() =>
  import("./viewsTelkomsel/DSADismantle/DSADMigration")
);
