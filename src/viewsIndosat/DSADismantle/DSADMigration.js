...
let headerFormatDSAMigration = [
  ...
  "LDM_Approved_By",
  "LDM_Approved_Date",
  "LDM_Admin_Approved_By",
  "LDM_Admin_Approved_Date",
  "GR_Number",
  "GR_Submit_By",
  "GR_Submit_Date",
  "Section_1_Details_1",
  "Section_1_Service_Master_1",
  "Section_1_Qty_1",
  "Section_1_Details_2",
  "Section_1_Service_Master_2",
  "Section_1_Qty_2",
  "Section_1_Details_3",
  "Section_1_Service_Master_3",
  "Section_1_Qty_3",
  "Section_1_Details_4",
  "Section_1_Service_Master_4",
  "Section_1_Qty_4",
  "Section_1_Details_5",
  "Section_1_Service_Master_5",
  "Section_1_Qty_5",
  "Section_1_Details_6",
  "Section_1_Service_Master_6",
  "Section_1_Qty_6",
  "Section_1_Details_7",
  "Section_1_Service_Master_7",
  "Section_1_Qty_7",
  "Section_1_Details_8",
  "Section_1_Service_Master_8",
  "Section_1_Qty_8",
  "Section_1_Details_9",
  "Section_1_Service_Master_9",
  "Section_1_Qty_9",
  "Section_1_Details_10",
  "Section_1_Service_Master_10",
  "Section_1_Qty_10",
  "Additional_Section_2_Details_1",
  "Additional_Section_2_Service_Master_1",
  "Additional_Section_2_Qty_1",
  "Additional_Section_2_Details_2",
  "Additional_Section_2_Service_Master_2",
  "Additional_Section_2_Qty_2",
  "Additional_Section_2_Details_3",
  "Additional_Section_2_Service_Master_3",
  "Additional_Section_2_Qty_3",
  "Additional_Section_2_Details_4",
  "Additional_Section_2_Service_Master_4",
  "Additional_Section_2_Qty_4",
  "Additional_Section_2_Details_5",
  "Additional_Section_2_Service_Master_5",
  "Additional_Section_2_Qty_5",
  "Additional_Section_2_Details_6",
  "Additional_Section_2_Service_Master_6",
  "Additional_Section_2_Qty_6",
  "Additional_Section_2_Details_7",
  "Additional_Section_2_Service_Master_7",
  "Additional_Section_2_Qty_7",
  "Additional_Section_2_Details_8",
  "Additional_Section_2_Service_Master_8",
  "Additional_Section_2_Qty_8",
  "Additional_Section_2_Details_9",
  "Additional_Section_2_Service_Master_9",
  "Additional_Section_2_Qty_9",
  "Additional_Section_2_Details_10",
  "Additional_Section_2_Service_Master_10",
  "Additional_Section_2_Qty_10",
  "Additional_Section_3_Type_Cost_1",
  "Additional_Section_3_Description_1",
  "Additional_Section_3_Price_1",
  "Additional_Section_3_Type_Cost_2",
  "Additional_Section_3_Description_2",
  "Additional_Section_3_Price_2",
  "Additional_Section_3_Type_Cost_3",
  "Additional_Section_3_Description_3",
  "Additional_Section_3_Price_3",
  "Additional_Section_3_Type_Cost_4",
  "Additional_Section_3_Description_4",
  "Additional_Section_3_Price_4",
  "Additional_Section_3_Type_Cost_5",
  "Additional_Section_3_Description_5",
  "Additional_Section_3_Price_5",
  "Additional_Section_3_Type_Cost_6",
  "Additional_Section_3_Description_6",
  "Additional_Section_3_Price_6",
  "Additional_Section_3_Type_Cost_7",
  "Additional_Section_3_Description_7",
  "Additional_Section_3_Price_7",
  "Additional_Section_3_Type_Cost_8",
  "Additional_Section_3_Description_8",
  "Additional_Section_3_Price_8",
  "Additional_Section_3_Type_Cost_9",
  "Additional_Section_3_Description_9",
  "Additional_Section_3_Price_9",
  "Additional_Section_3_Type_Cost_10",
  "Additional_Section_3_Description_10",
  "Additional_Section_3_Price_10",
];
...
class DSADMigration extends Component {
  constructor(props) {
    ...
    this.exportFormatBulkDSAMigration = this.exportFormatBulkDSAMigration.bind(
      this
    );
  ...
  async checkingDataAssignment(dataXLS) {
    ...
    const respondCheckingASG = await patchDatatoAPINODE(
            ...
            <Card>
              <CardHeader>
                <span style={{ lineHeight: "2", fontSize: "17px" }}>
                  DSA SRN Migration Bulk{" "}
                </span>
                <Button
                  style={{ marginRight: "8px", float: "right" }}
                  outline
                  color="info"
                  onClick={this.exportFormatBulkDSAMigration}
                  size="sm"
                >
                  <i
              ...
              <CardBody className="card-UploadBoq">
                <Row>
                  <Col>
                    <input
                      type="file"
                      onChange={this.fileHandlerDSAMigration.bind(this)}
                      style={{ padding: "10px", visiblity: "hidden" }}
                    />
                    <Button
                      color="success"
                      onClick={this.saveDataDSAMigrationBulk}
                      style={{ float: "right" }}
                      disabled={
                  ...
                  <tbody>
                    <tr>
                      <td colSpan="4" style={{ textAlign: "center" }}>
                        DSA SRN MIGRATION UPLOADER PREVIEW
                      </td>
                    </tr>
                    <tr>
                      <td
