    ...
    if (!inputValue) {
      ...
      const getMR = await this.getDataFromAPINODE(
        '/matreq?srt=_id:-1&q={"mr_id":{"$regex":"' +
          inputValue +
          '", "$options":"i"}}&v={"mr_id":1, "dsa_number":1}'
      );
      ...
      if (updateDSA.primary_section.length === 0) {
        ...
        if (
          ...
          let res = await this.patchDatatoAPINODE(
            ...
            { account_id: "2", submitType: 0, data: updateDSA }
          );
                      ...
                      <Col md="3">
                        <FormGroup style={{ paddingLeft: "16px" }}>
                          ...
                          <Input
                            ...
                            value={
                              this.state.list_mr_selected !== null
                                ? this.state.list_mr_selected.current_mr_status
                                : ""
                            }
                          />
                        </FormGroup>
                      ...
                      <Col md="3">
                        <FormGroup style={{ paddingLeft: "16px" }}>
                          ...
                          <Input
                            ...
                            value={
                              this.state.list_mr_selected !== null
                                ? "DSA" + this.state.list_mr_selected.mr_id
                                : ""
                            }
                          />
                        </FormGroup>
