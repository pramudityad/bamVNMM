...
class AssingPStoMRWH extends Component {
  ...
  getListTssrAll() {
    getDatafromAPINODE(
      '/plantspec?q={"mr_id" : null, "submission_status" : "SUBMITTED", "origin_wh.value" : "' +
  ...
  getDataMR(_id_MR) {
    getDatafromAPINODE("/matreq/" + _id_MR, this.state.tokenUser).then(
      (resMR) => {
  ...
  getDataTssr(_id_tssr) {
    getDatafromAPINODE("/plantspec/" + _id_tssr, this.state.tokenUser).then(
      (resTssr) => {
  ...
  async getDataWarehouse(listSku) {
    if (listSku !== null && listSku !== undefined) {
      ...
      const respondSKU = await postDatatoAPINODE(
  ...
  async connectMRtoPSWarehouse() {
    ...
    patchDatatoAPINODE(
      ...
      if (res.data !== undefined) {
        if (
          dataMRParent.mr_delivery_type_code === "A1" ||
          dataMRParent.mr_delivery_type_code === "A2" ||
          dataMRParent.mr_delivery_type_code === "B1" ||
          dataMRParent.mr_delivery_type_code === "C1"
        ) {
          patchDatatoAPINODE(
        ...
        this.setState({ action_status: "success" }, () => {
          setTimeout(
            function () {
              this.setState({ redirectSign: this.props.match.params.id });
            }.bind(this),
            2000
          );
        });
            ...
            <Card>
              <CardHeader>
                ...
                <Button
                  color="success"
                  style={{ float: "right" }}
                  disabled={this.state.ps_wh_data.packages === undefined}
                  onClick={this.connectMRtoPSWarehouse}
                >
                  Assign
                </Button>
              </CardHeader>
                    ...
                    {this.state.data_mr !== null && (
                      <Fragment>
                        <tr>
                          ...
                          >
                            MR Warehouse ID : {this.state.data_mr.mr_id}
                          </td>
                        </tr>
                        <tr>
                          <td
                        ...
                        <tr>
                          ...
                          >
                            Category : {this.state.data_mr.mr_delivery_type}
                          </td>
                        </tr>
                        <tr>
                          <td
                          ...
                          >
                            Origin WH :{" "}
                            {this.state.data_mr.origin !== undefined
                              ? this.state.data_mr.origin.value
                              : null}
                          </td>
                        </tr>
                        <tr>
                          ...
                          >
                            Destination WH :{" "}
                            {this.state.data_mr.destination !== undefined
                              ? this.state.data_mr.destination.value
                              : null}
                          </td>
                        </tr>
