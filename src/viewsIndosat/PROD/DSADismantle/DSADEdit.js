...
class DSADUpdate extends Component {
  constructor(props) {
    super(props);
  ...
  async submitDSA(e) {
    ...
    let res = await this.patchDatatoAPINODE('/matreq/DSADUpdate/' + _id, { "account_id": "2", "data": updateDSA });
    if (res !== undefined) {
...
export default connect(mapStateToProps)(DSADUpdate);
