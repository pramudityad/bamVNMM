...
class MRDisCreation extends Component {
  constructor(props) {
    ...
    this.loadOptionsWPIDDestination = this.loadOptionsWPIDDestination.bind(
      this
    );
    this.handleChangeWPID = this.handleChangeWPID.bind(this);
    this.handleChangeWPIDDestination = this.handleChangeWPIDDestination.bind(
      this
    );
  ...
  getDSPList() {
    getDatafromAPIISAT('/vendor_data_non_page?where={"Type":"ASP"}').then(
      (res) => {
  ...
  async loadOptionsWPID(inputValue) {
    if (!inputValue || inputValue.length < 3) {
      ...
      const getTowerID = await getDatafromAPIISAT(
        '/custdel_op?where={"WP_ID":{"$regex":"' +
          inputValue +
          '", "$options":"i"}}&projection={"WP_ID":1,"WP_Name":1,"CD_Info_Project_Name":1,"CD_Info_Project":1,"Site_Info_SiteID_Value_NE":1,"Site_Info_SiteName_NE":1}'
      );
      if (getTowerID !== undefined && getTowerID.data !== undefined) {
        ...
        getTowerID.data._items.map((wp) =>
          site_id_list.push({
            ...
            WP_ID: wp.WP_ID,
            WP_Name: wp.WP_Name,
            Project_Name: wp.CD_Info_Project_Name,
  ...
  async loadOptionsASG(inputValue) {
    if (!inputValue) {
      ...
      let asg_list = [];
      const getASG = await this.getDataFromAPINODE(
        '/aspAssignment/aspassign?srt=_id:-1&q={"Assignment_No":{"$regex":"' +
          inputValue +
          '", "$options":"i"}}&v={"Assignment_No":1, "Site_ID" : 1}'
      );
      if (getASG !== undefined && getASG.data !== undefined) {
        this.setState({ list_asg_selection: getASG.data.data }, () =>
          getASG.data.data.map((mr) =>
            asg_list.push({
              label: mr.Assignment_No !== undefined ? mr.Assignment_No : null,
              value: mr._id,
              site_id_asg: mr.Site_ID,
            })
          )
        );
      }
  ...
  async saveMRDis() {
    ...
    const dataMR = [
      ...
      [
        "new",
        dataForm.wp_id,
        dataForm.project_name,
        dataForm.destination,
        dataForm.eta,
        dataForm.etd,
        dataForm.deliver_by,
        dataForm.dismantle_by,
        dataForm.warehouse,
        dataForm.warehouse === "TWH" ? null : dataForm.wp_id_destination,
        dataForm.warehouse === "TWH" ? null : dataForm.project_name_destination,
        dataForm.assignment_id === undefined ? null : dataForm.assignment_id,
        dataForm.mra_type,
        dataForm.mr_id !== undefined ? dataForm.mr_id : null,
        dataForm.notes === undefined ? null : dataForm.notes,
      ],
    ];
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="mra_type"
                          value={this.state.form_creation.mra_type}
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="site_name"
                          readOnly
                          value={this.state.form_creation.wp_name}
                    ...
                    <Col md={4}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="site_id"
                          readOnly
                          value={this.state.form_creation.site_id}
                          onChange={this.handleChangeProject}
                        />
                      </FormGroup>
                    </Col>
                    ...
                    <Col md={4}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="project_name"
                          readOnly
                          value={this.state.form_creation.project_name}
                          onChange={this.handleChangeProject}
                        />
                      </FormGroup>
                    </Col>
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="destination"
                          value={this.state.form_creation.destination}
                          onChange={this.handleChangeDropdown}
                        >
                          <option value="" disabled selected hidden>
                            Select Destination
                      ...
                      <FormGroup>
                        <Label>
                          ...
                          {this.state.form_creation.destination === "TWH" && (
                            <span style={{ color: "rgba(216,67,21 ,1)" }}>
                              *
                            </span>
                          )}
                        </Label>
                        <Input
                          type="select"
                          name="warehouse"
                          value={this.state.form_creation.warehouse}
                          onChange={this.handleChangeDropdown}
                        >
                          <option value="" disabled selected hidden>
                            Select Warehouse
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="dismantle_by"
                          value={this.state.form_creation.dismantle_by}
                          onChange={this.handleChangeDropdown}
                          style={
                            this.state.validation_form.dismantle_by === false
                              ? { borderColor: "red" }
                              : {}
                          }
                        >
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="deliver_by"
                          value={this.state.form_creation.deliver_by}
                          onChange={this.handleChangeDropdown}
                          style={
                        ...
                        <Col md={6}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              readOnly
                              value={
                                this.state.form_creation.wp_name_destination
                              }
                              onChange={this.handleChangeProject}
                            />
                          </FormGroup>
                        ...
                        <Col md={4}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              readOnly
                              value={
                                this.state.form_creation.site_id_destination
                              }
                              onChange={this.handleChangeProject}
                            />
                          </FormGroup>
                        ...
                        <Col md={4}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              readOnly
                              value={
                                this.state.form_creation.site_name_destination
                              }
                              onChange={this.handleChangeProject}
                            />
                          </FormGroup>
                        ...
                        <Col md={4}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              readOnly
                              value={
                                this.state.form_creation
                                  .project_name_destination
                              }
                              onChange={this.handleChangeProject}
                            />
                          </FormGroup>
                    ...
                    <Col md={3}>
                      <FormGroup>
                        ...
                        <Input
                          type="date"
                          name="etd"
                          value={this.state.form_creation.etd}
                    ...
                    <Col md={3}>
                      <FormGroup>
                        ...
                        <Input
                          type="date"
                          name="eta"
                          value={this.state.form_creation.eta}
                          onChange={this.handleChangeText}
                        />
                      </FormGroup>
                    </Col>
                  ...
                  <Row form>
                    <Col md={3}>
                      <FormGroup>
                        ...
                        <Input
                          type="textarea"
                          name="notes"
                          value={this.state.form_creation.notes}
                          onChange={this.handleChangeText}
                        />
                      </FormGroup>
                    </Col>
                    <Col md={3}>
                      <FormGroup>
                        ...
                        <AsyncSelect
                          loadOptions={this.loadOptionsASG}
                          defaultOptions
                          onChange={this.handleChangeASG}
                        />
                      </FormGroup>
                    </Col>
                    <Col md={3}>
                      <FormGroup>
                        ...
                        <Input
                          type="text"
                          name="site_id_asg"
                          value={this.state.form_creation.site_id_asg}
                          readOnly
                        />
                      </FormGroup>
                    </Col>
