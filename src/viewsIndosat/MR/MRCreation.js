...
class MRCreation extends Component {
  ...
  getDataTower() {
    this.getDatafromAPIXL(
      '/tower_site_sorted_non_page?projection={"site_id" : 1}'
    ).then((resTower) => {
  ...
  async loadOptionsSiteID(inputValue) {
    if (!inputValue || inputValue.length < 3) {
      ...
      const getSiteID = await this.getDatafromAPIXL(
                    ...
                    <Col md={2}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="15"
                          value={this.state.create_mr_form[15]}
                          onChange={(e) => {
                    ...
                    <Col md={5}>
                      <FormGroup>
                        ...
                        >
                          ...
                          <option
                            value="Site to Site"
                            hidden={this.state.toggle_display !== "relocation"}
                          >
                            Site to Site
                          </option>
