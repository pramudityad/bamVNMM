...
class MRDetail extends Component {
  ...
  async getDataCDID(array_cd_id) {
    ...
    const getWPID = await this.getDatafromAPIISAT(
  ...
  getDSPList() {
    this.toggleLoading();
    this.getDatafromAPIISAT('/vendor_data_non_page?where={"Type":"ASP"}').then(
      (res) => {
        if (res.data !== undefined) {
          ...
          <Col xl="12">
            <Card>
                          ...
                          {(this.state.data_mr.mr_delivery_type_code === "A1" ||
                            ...
                            <Fragment>
                              <div className="mr-detail__flex-body--25">
                                ...
                                <div>
                                  {this.state.data_mr["destination"] !==
                                  undefined
                              ...
                              <div className="mr-detail__flex-body--25">
                                ...
                                <div>
                                  {this.state.data_mr["destination"] !==
                                  undefined
                                    ? this.state.data_mr["destination"].name
                                    : null}
                                </div>
                              </div>
                            </Fragment>
                ...
                {this.state.tabs_submenu[1] === true && (
                  <Fragment>
                                ...
                                this.state.data_mr.mr_type !== "Return" ? (
                                  ...
                                  <Fragment>
                                    ...
                                    {(this.state.userRole.findIndex(
                                      ...
                                      this.state.userRole.findIndex(
                                        (e) =>
                                          e === "BAM-Implementation Coordinator"
                                      ) !== -1 ||
                                      this.state.userRole.findIndex(
                                        (e) => e === "Admin"
                                      ) !== -1) &&
                    ...
                    (this.state.data_mr.mr_delivery_type_code === "A1" ||
                      ...
                      <div>
                        PlantSpec Warehouse No :{" "}
                        {this.state.data_mr !== null ? (
                          <Link
                            to={
                              "/ps-list/" + this.state.data_mr.id_plantspec_doc
                            }
                          >
              ...
              <CardFooter>
                {this.state.data_mr !== null &&
                  this.state.data_mr.current_mr_status !== "MR CANCELED" &&
                  (this.state.userRole.findIndex((e) => e === "LDM") !== -1 ||
                    this.state.userRole.findIndex(
                      (e) => e === "BAM-Implementation Manager"
                    ) !== -1 ||
                    this.state.userRole.findIndex(
