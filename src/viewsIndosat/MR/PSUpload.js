...
class PSUpload extends Component {
  ...
  async connectMRtoTSSR() {
    ...
    for (let j = 0; j < this.state.list_tssr_from_ps.length; j++) {
      dataCDIDMR.push({
        id_tssr_boq_site_doc: this.state.list_tssr_from_ps[j]
                      ...
                      <Fragment>
                        ...
                        {this.state.data_mr.sow_type === "TRM" && (
                          <tr>
                            ...
                            >
                              MR Site FE :{" "}
                              {this.state.data_mr.site_info[1].site_id}
                            </td>
                          </tr>
                        )}
                      </Fragment>
                                  ...
                                  this.state.data_mr.mr_type === "Return" ? (
                                    ...
                                    <Fragment>
                                      <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                          {this.state.data_tssr.site_info !==
                                          undefined
                                            ? this.state.data_tssr.site_info[0]
                                                .site_id
                                            : ""}
                                        </td>
                                      </tr>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      {this.state.data_tssr.site_info !==
                                        undefined &&
                                      this.state.data_tssr.site_info[1] !==
                                        undefined
                                        ? this.state.data_tssr.site_info[1]
                                            .site_id
                                        : ""}
