...
import { getDatafromAPINODE, patchDatatoAPINODE, getDatafromAPIISAT } from "../../helper/asyncFunction";
...
class DetailPRPO extends Component {
  ...
  componentDidMount() {
    ...
    dateToday = (dateToday.getFullYear().toString())+"-"+(dateToday.getMonth()+1).toString().padStart(2, '0')+"-"+(dateToday.getDate().toString().padStart(2, '0'));
    this.setState({data_form : {'date_now' : dateToday}});
  ...
  handleInputGR(e){
    ...
    this.setState(
      ...
      () => console.log(this.state.data_form)
    );
    // this.setState({data_form : dataForm});
  }
  ...
  getGRData(prt_data){
    ...
    getDatafromAPIISAT('/gr_prt_op/'+where_bast, this.props.dataLogin.token).then((res) => {
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={10}>
                            ...
                            readOnly
                              ...
                              name={"req_gr_by_dp"}
                              value={(all_data.bast_no_dp !== null && all_data.bast_no_dp !== undefined) ? all_data.req_gr_by_dp : this.state.userEmail}
                              onChange={this.handleInputGR}
                            />
                          </Col>
                        </FormGroup>
                        <FormGroup row>
                          ...
                          <Col sm={10}>
                            <Input
                              ...
                              name={"req_gr_date_dp"}
                              value={(all_data.bast_no_dp !== null && all_data.bast_no_dp !== undefined) ? all_data.req_gr_date_dp : this.state.date_now}
                              onChange={this.handleInputGR}
                            />
                          </Col>
                        </FormGroup>
                      ...
                      <FormGroup row>
                        ...
                        <Col sm={10}>
                          <Input
                            ...
                            value={(all_data.bast_no_final !== null && all_data.bast_no_final !== undefined) ? all_data.req_gr_by_final : this.state.userEmail }
                            onChange={this.handleInputGR}
                          />
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        ...
                        <Col sm={10}>
                          ...
                          readOnly
                            ...
                            value={(all_data.bast_no_final === null && all_data.bast_no_final === undefined) ? all_data.req_gr_date_final : this.state.date_now}
                            onChange={this.handleInput}
                          />
                        </Col>
                      </FormGroup>
