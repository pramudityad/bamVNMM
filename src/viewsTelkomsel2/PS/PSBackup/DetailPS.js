...
class DetailPS extends Component {
  constructor(props) {
    super(props);
  ...
  formatDataTSSR = async (dataXLS) => {
    ...
    if (staticHeaderXLS.equals(staticHeader) !== true) {
      ...
      this.setState({
        action_status: "failed",
        action_message: "Please check your upload format or Package Number",
      });
    }
    if (actionStatus !== "failed") {
      ...
      for (let j = index_item; j < dataXLS[1].length; j++) {
        ...
        let cekAllZero = dataXLS
          .map((e) => this.checkValuetoZero(e[j]))
          .filter((e, n) => n > 1);
      ...
      for (let i = 2; i < dataXLS.length; i++) {
        if (
          ...
          let siteTssrBOM = {
            account_id: "1",
            site_id: siteID,
            site_name: this.checkValue(
              dataXLS[i][this.getIndex(dataXLS[1], "site_name")]
            ),
            site_title: this.checkValue(
              dataXLS[i][this.getIndex(dataXLS[1], "site_title")]
            ),
          ...
          if (
            siteSaveFormat.find((e) => e === siteTssrBOM.site_id) !== undefined
          ) {
          ...
          <Col xl="12">
            <Card>
              <CardHeader>
                ...
                this.state.tssrData.submission_status !== "SUBMITTED" ? (
                  <Button
                    ...
                    {this.state.tssrData !== null && (
                      <Fragment>
                        ...
                        <tr>
                          ...
                          >
                            Site ID : {this.state.tssrData.site_info[0].site_id}
                          </td>
                        </tr>
                        <tr>
                          <td
                                ...
                                <Fragment>
                                  ...
                                  >
                                    <Select
                                      cacheOptions
                                      options={
                                        this.state.list_technical_ref_selection
                                      }
                                  ...
                                  >
                                    <Button
                                      ...
                                      onClick={this.referenceWithTechBoq}
                                    >
                                      Submit
                                    </Button>
                                  </td>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td style={{ paddingLeft: "10px" }}>
                                  {this.state.tssr_site_NE.site_id}
                                </td>
                              </tr>
                              <tr>
                                <td>Site Name NE</td>
                                  ...
                                  <Input
                                    ...
                                    value={
                                      this.state.version_selected === null
                                        ? this.state.version_current
                                        : this.state.version_selected
                                    }
                                  >
                                    <option
                                      value={this.state.data_tssr.version}
                                    >
                                      {this.state.data_tssr.version}
                                    </option>
                            ...
                            <table className="table-header">
                              <tbody>
                                <tr>
                                  ...
                                  <td>: &nbsp;</td>
                                  <td style={{ paddingLeft: "10px" }}>
                                    {this.state.tssr_site_FE.site_id}
                                  </td>
                                </tr>
                                <tr>
                                  <td>Site Name FE</td>
...
export default connect(mapStateToProps)(DetailPS);
