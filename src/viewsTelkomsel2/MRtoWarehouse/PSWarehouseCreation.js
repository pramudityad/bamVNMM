...
class PSWarehouseCreation extends Component {
  ...
  async savePSWH() {
    ...
    const resPost = await postDatatoAPINODE(
      "/plantspec/createPlantSpecWhtoWh",
      dataPSCreate,
      this.state.tokenUser
    );
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          type="select"
                          name="delivery_type"
                          value={this.state.form_creation_ps_wh.delivery_type}
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          value={
                            this.state.form_creation_ps_wh.project_selected
                          }
                          onChange={this.handleChangeDropdown}
                        >
                          <option value="" disabled selected hidden>
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          value={this.state.origin_warehouse}
                          onChange={this.handleChangeDropdown}
                        >
                          <option value="" disabled selected hidden>
                            Select Destination
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          readOnly
                          value={
                            this.state.form_creation_ps_wh.origin_warehouse_name
                          }
                          onChange={this.handleChangeDropdown}
                        />
                      </FormGroup>
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          value={
                            this.state.form_creation_ps_wh.destination_warehouse
                          }
                          onChange={this.handleChangeDropdown}
                        >
                          <option value="" disabled selected hidden>
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          readOnly
                          value={
                            this.state.form_creation_ps_wh
