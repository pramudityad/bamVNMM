...
class LoadingProcess extends React.PureComponent {
  ...
  async downloadMRlist() {
    ...
    saveAs(new Blob([allocexport]), "MR List Loading Process.xlsx");
  }
  ...
  handleChangeShipmentDetail(e) {
    ...
    this.setState({ shipment_detail: dataShipment }, () =>
      console.log(this.state.shipment_detail)
    );
  }
                  ...
                  <thead>
                    <tr>
                      ...
                      <th>
                        <Checkbox
                          type="checkbox"
                          checked={this.state.no_filter_dsp}
                          onChange={this.handleChangeFilterDSP}
                        />
                        DSP
                      </th>
                      <th>ETA</th>
