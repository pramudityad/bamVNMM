...
class TechnicalBoq extends Component {
        ...
        if (res.data !== undefined) {
          ...
          if (res.data.data !== undefined) {
            this.setState(
              ...
              () => {
                this.viewTechBoqDataTSEL(dataTech.data.techBoqSite);
              }
            );
          }
        }
  ...
  viewTechBoqDataTSEL(data_sites) {
  ...
  exportTechnicalHorizontal = async () => {
    ...
    saveAs(
      new Blob([MRFormat]),
      "Technical BOQ " + dataTech.no_tech_boq + ".xlsx"
    );
  };
                          ...
                          >
                            <tbody>
                              ...
                              >
                                ...
                                <td style={{ textAlign: "left" }}>:</td>
                                <td style={{ textAlign: "left" }} colspan={2}>
                                  {this.state.data_tech_boq.tech_boq_status !==
                                    undefined &&
                                  this.state.data_tech_boq.tech_boq_status.find(
                                    (tbs) => tbs.status_value === "CREATED"
                                  ) !== undefined
                                    ? this.state.data_tech_boq.tech_boq_status.find(
                                        (tbs) => tbs.status_value === "CREATED"
                                      ).status_updater
                            ...
                            <tbody>
                              ...
                              >
                                ...
                                <td style={{ textAlign: "left" }} colspan={2}>
                                  ...
                                  undefined
                                    ? this.state.data_tech_boq.tech_boq_status.find(
                                        (tbs) => tbs.status_value === "UPDATED"
                                      ) !== undefined
                                      ? this.state.data_tech_boq.tech_boq_status.find(
                                          (tbs) =>
                                            tbs.status_value === "UPDATED"
                                        ).status_updater
                                      : this.state.data_tech_boq.tech_boq_status.find(
                                          (tbs) =>
                                            tbs.status_value === "CREATED"
                                        ) !== undefined
                                      ? this.state.data_tech_boq.tech_boq_status.find(
                                          (tbs) =>
                                            tbs.status_value === "CREATED"
