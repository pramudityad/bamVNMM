...
import {getDatafromAPIISAT,getDatafromAPINODE, postDatatoAPINODE, patchDatatoAPINODE, deleteDataFromAPINODE} from '../../helper/asyncFunction'
...
class ASPUserManagement extends React.Component {
  ...
  loadOptionsASP() {
    getDatafromAPIISAT('/vendor_data_non_page', this.state.tokenUser).then(res => {
