  ...
  handleChangeQTY(e, i, u){
    ...
    this.setState(
      (prevState) => ({
        qty_ps: [
          ...prevState.qty_ps,
          [Data_mat._id, Data_package.pp_id, Data_package.product_name, Data_package.program, Data_mat.material_id_plan, Data_mat.material_name_plan, Data_mat.material_id_plan, Data_mat.material_name_plan, Data_mat.uom, value_qty]
        ],
      }),
                              ...
                              <tr style={{backgroundColor : 'rgba(248,246,223, 0.5)'}} className="fixbody">
                                ...
                                <td key={idxMat} align='center'>
                                  {this.state.collapseUpload === true ? (
                                    <Input type="number" min="0" defaultValue={(material.qty).toFixed(2)} onChange={e => {this.handleChangeQTY(e, idxMat, idxPP)} } />
                                  ) : material.qty }
                                </td>
