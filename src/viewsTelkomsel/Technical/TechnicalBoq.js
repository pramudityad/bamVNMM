                ...
                <CardBody className='card-UploadBoq'>
                  ...
                  <CardFooter>
                    <div style={{display : 'flex'}}>
                      ...
                      {(this.state.data_tech_boq !== null && (this.state.data_tech_boq.tssr_approval_status === "NOT SUBMITTED" || this.state.data_tech_boq.tssr_approval_status === "WAITING FOR TSSR CONFIRM")) ? (
                        <Col>
                          <Button size="sm" className="btn-success" style={{'float' : 'left', marginLeft : '10px'}} color="success" value="4" onClick={this.submitTSSR} disabled={false}>
                              {this.state.data_tech_boq.tssr_approval_status === "NOT SUBMITTED" || this.state.data_tech_boq.tssr_approval_status === "WAITING FOR TSSR CONFIRM" ? "Submit to TSSR" : "TSSR Submitted"}
                          </Button>
                        </Col>
                      ) : (
                        <Col>
