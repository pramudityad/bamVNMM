...
class ListTSSRBoq extends Component {
  ...
  getTechBoqList() {
    let filter_no_tssr =
      this.state.filter_list[0] === null
        ? '"no_tssr_boq":{"$exists" : 1}'
        : '"no_tssr_boq":{"$regex" : "' +
            ...
            <Card>
              ...
              <CardBody className="card-UploadBoq">
                ...
                <Col>
                  <span>
                    {" "}
                    View {this.state.list_tech_boq.length} data from total{" "}
