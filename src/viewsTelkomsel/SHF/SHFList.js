...
const array_field = ["shf_no", "related_to", "related_no", "site_id", "site_name", "site_location.latitude", "site_location.longitude", "distance", "amount_paid", "receiver_name", "receiver_email", "receiver_note",  "creator.email", "created_on"]
...
class SHFList extends Component {
  ...
  async downloadSHFList() {
    ...
    let headerRow = ["SHF No.", "Related To", "Related No.", "Site ID", "Site Name", "Latitude", "Longitude", "Distance", "Amount Paid", "Receiver Name", "Receiver Email", "Note", "Receiver Phone", "Created By", "Created On"];
    ws.addRow(headerRow);
