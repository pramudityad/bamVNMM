  ...
  async getCommBoqData(_id) {
    ...
    if (getComm.data !== undefined) {
      ...
      this.setState({
        ...
        list_version: new Array(parseInt(dataComm.data.version) + 1).fill("0"),
      });
    }
  }
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  >
                                    ...
                                    <option value={null}>PO 001</option>
                                    <option value={null}>PO 002</option>
                                    <option value={null}>PO 003</option>
