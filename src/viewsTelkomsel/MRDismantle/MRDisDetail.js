...
class MRDisDetail extends Component {
  ...
  getASPList() {
    ...
    //   case "xl":
    this.getDatafromAPITSEL('/vendor_data_non_page?where={"Type":"DSP"}').then((res) => {
              ...
              <CardBody>
                ...
                {this.state.tabs_submenu[1] === true && (
                  <Fragment>
                    ...
                    <div>PlantSpec Dismantle No : {this.state.data_mr !== null ? (<Link to={'/dismantle/ps-dis-detail/'+this.state.data_mr.id_plantspec_doc}>{this.state.data_mr.srn_plantspec !== undefined ? this.state.data_mr.srn_plantspec.length !== 0 ? this.state.data_mr.srn_plantspec[0].no_plantspec_srn : null : null}</Link>) : ""}</div>
