              ...
              <CardBody>
                ...
                {this.state.tabs_submenu[1] === true && (
                  <Fragment>
                    ...
                    <div>PlantSpec Group No : {this.state.data_mr !== null ? (<Link to={'/srn/ps-srn-detail/'+this.state.data_mr.id_plantspec_doc}>{this.state.data_mr.srn_plantspec !== undefined && this.state.data_mr.srn_plantspec.length !== 0 ? this.state.data_mr.srn_plantspec[0].no_plantspec_srn : null}</Link>) : ""}</div>
