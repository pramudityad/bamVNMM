...
import { getDatafromAPITSEL, postDatatoAPINODE} from "../../helper/asyncFunction";
...
class PSDisCreation extends Component {
  ...
  async savePSDis(){
    ...
    const resPost = await postDatatoAPINODE('/plantspec-srn/createPlantSpecSRN', dataPSCreate, this.state.tokenUser)
