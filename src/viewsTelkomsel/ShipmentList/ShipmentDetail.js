...
class ShipmentDetail extends Component {
  ...
  getMRList() {
    ...
    let filter_mr_id =
      this.state.filter_list[0] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[0] + '", "$options" : "i"}';
    let filter_implementation_id =
      this.state.filter_list[1] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[1] + '", "$options" : "i"}';
    let filter_project_name =
      this.state.filter_list[2] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[2] + '", "$options" : "i"}';
    let filter_cd_id =
      this.state.filter_list[3] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[3] + '", "$options" : "i"}';
    let filter_site_id =
      this.state.filter_list[4] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[4] + '", "$options" : "i"}';
    let filter_site_name =
      this.state.filter_list[5] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[5] + '", "$options" : "i"}';
    let filter_current_status =
      this.state.filter_list[6] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[6] + '", "$options" : "i"}';
    let filter_current_milestones =
      this.state.filter_list[7] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[7] + '", "$options" : "i"}';
    let filter_dsp =
      this.state.filter_list[8] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[8] + '", "$options" : "i"}';
    let filter_asp =
      this.state.filter_list[9] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[9] + '", "$options" : "i"}';
    let filter_eta =
      this.state.filter_list[10] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[10] + '", "$options" : "i"}';
    let filter_created_by =
      this.state.filter_list[11] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[11] + '", "$options" : "i"}';
    let filter_updated_on =
      this.state.filter_list[12] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[12] + '", "$options" : "i"}';
    let filter_created_on =
      this.state.filter_list[13] === ""
        ? '{"$exists" : 1}'
        : '{"$regex" : "' + this.state.filter_list[13] + '", "$options" : "i"}';
    let whereAnd =
      '{"mr_id": ' + filter_mr_id + ',"current_milestones": "MS_JOINT_CHECK"}';
    ...
    this.getDataFromAPINODE(
      "/matreq?q=" + whereAnd + "&lmt=" + maxPage + "&pg=" + page
    ).then((res) => {
  ...
  getAllMR() {
    ...
    let whereAnd =
      ...
      ', "current_milestones": "MS_JOINT_CHECK", "dsp_company": ' +
      filter_dsp +
      ', "asp_company": ' +
      filter_asp +
      ', "eta": ' +
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                        <Input
                          ...
                          onChange={this.handleChangeShipmentDetail}
                          value={this.state.shipment_detail.driver_phone_number}
                        />
                      </Col>
                    </FormGroup>
                  </Col>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              value={this.state.filter_list[0]}
                              name={0}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[3]}
                              name={3}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[6]}
                              name={6}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[7]}
                              name={7}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[8]}
                              name={8}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[9]}
                              name={9}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[10]}
                              name={10}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[11]}
                              name={11}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[12]}
                              name={12}
                              size="sm"
                            />
                          </InputGroup>
                        ...
                        <div className="controls" style={tableWidth}>
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              placeholder="Search"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[13]}
                              name={13}
                              size="sm"
                            />
                          </InputGroup>
