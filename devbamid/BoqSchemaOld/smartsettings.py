...
from boqcommercialitemschemawithoutrelation import boqcommercialitemschemawithoutrelation
...
X_DOMAINS = ['http://localhost:3000', 'http://52.230.4.218:5002', 'http://localhost:3005', 'https://smart.pdb-flow.e-dpm.com', 'https://smart.e-dpm.com', 'https://ops.e-dpm.com', 'https://test.ops.e-dpm.com', 'https://mittapp.com', 'https://dev.bam-id.e-dpm.com']
...
boq_comm_items_op = {
    ...
    'item_methods': ['PUT', 'PATCH', 'GET'],
    'versioning' : False,
    'schema' : boqcommercialitemschemawithoutrelation,
}
            ...
            'pipeline': [
                {
                    '$lookup': {
                        'from': 'boq_commercial', 
                        'localField': 'id_boq_comm_doc', 
                        'foreignField': '_id', 
                        'as': 'boq_comm_parent'
                    }
                }, {
                    '$unwind': {
                        'path': '$boq_comm_parent', 
                        'preserveNullAndEmptyArrays': True
                    }
                }, {
                    '$match': {
                        'boq_comm_parent.project_name': '$project_name',
                        'fas_assignment_id': {
                            '$exists': True
                        },
                        'deleted' : 0
                    ...
                    '$project': {
                        ...
                        'id_po_doc': 1, 
                        'po_number': 1, 
                        'qty_comm_quotation': 1, 
                        'boq_comm_parent.id_project_doc': 1,
                        'boq_comm_parent.project_name': 1,
                        'qty_po': 1, 
                        'fas_assignment_id': 1
                    }
                }
...
fas_assignment_item_project_po = {
    'cache_control': 'max-age=10,must-revalidate',
    'cache_expires': 10,
    'datasource' : {
		'source' : 'boq_commercial_item',
            ...
            'pipeline': [
                {
                    ...
                    '$match': {
                        'boq_comm_parent.project_name': '$project_name',
                        'boq_comm_parent.po_number': '$po_number',
                        'fas_assignment_id': {
                            '$exists': True
                        },
                        'deleted' : 0
...
DOMAIN = {
    ...
    'fas_assignment_item_project' : fas_assignment_item_project,
    'fas_assignment_item_project_po' : fas_assignment_item_project_po,
}
